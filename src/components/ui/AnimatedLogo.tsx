  ...
  return (
    <div 
      className={cn(
        ...
        glowEffect && "after:absolute after:inset-0 after:opacity-20 after:blur-xl after:bg-gradient-to-r after:from-primary after:to-accent after:rounded-full after:-z-10",
